...
def tpfp_default(
    ...
    # print("len of gt_box:", len(gt_box))
...
def eval_map(
    ...
    for i in range(num_classes):
        ...
        print("cls_dets:", len(cls_dets[0]))
        print("cls_gts:", len(cls_gts[0]))
        ...
        # tp = np.sum(tp, axis=1, keepdims=True)
        # fp = np.sum(fp, axis=1, keepdims=True)
        print("tp:", tp)
        print("fp:", fp)
